...
==== How to do
. Get to Birt component in OFBiz image:../images/birt/Birt-Menus.png[Birt menus]
. Click on the "Flexible Report" menu (varies depending on themes)
. Click on the "Generate report" button, you get to this screen:
. Fill the form: image:../images/birt/Example-Report.png[Example Report]
...
image::../images/birt/Edit-Report-screen.png[Edit Report screen]
